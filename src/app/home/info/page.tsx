  ...
  return (
    <main className={montserrat.className + ' main-container pt-12'}>
      <div className='flex flex-col items-center'>
        ...
        <div className='mx-2 w-3/4 rounded-3xl'>
          <div className='mx-2 mb-4 flex flex-col items-center rounded-2xl border-t-4 border-base-orange bg-white bg-opacity-90 pb-4 pt-4 text-white'>
            <div
              className={
                lilita.className +
                ' mb-2 mt-6 w-5/6 border-b-2 border-b-dark-blue text-center text-2xl text-dark-blue'
              }
            >
              ORIGINS
            </div>
            <div className='w-5/6 rounded-lg p-2 pt-0 text-center text-base text-black'>
            ...
            <div
              className={
                lilita.className +
                ' mb-2 mt-6 w-5/6 rounded-t-lg border-b-2 border-b-dark-blue text-center text-2xl text-dark-blue'
              }
            >
              HISTORY
            </div>
            ...
            <div className='w-5/6 rounded-lg p-2 text-center text-base text-black'>
            ...
            <div className='w-5/6 rounded-lg p-2 pt-8 text-center text-base text-black'>
